                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid gap-6 md:gap-10 md:grid-cols-3">
                        {solutions.map((solution, index) => (
                            ...
                            >
                                <Card className="group relative overflow-hidden border-0 shadow-lg hover:shadow-xl transition-all duration-500 bg-white dark:bg-card h-full cursor-pointer">
                                    {/* 배경 그라디언트 */}
                        ...
                        const brandSolutions = [
                            {
                                ...
                                logo: <FreshworksLogo className="h-[70px] w-auto" />,
                            ...
                            },
                            {
                                ...
                                logo: <SplashtopLogo className="h-12 w-auto" />,
                            ...
                            <div className="grid gap-6 md:gap-10 md:grid-cols-2">
                                {brandSolutions.map((item, i) => (
                                    <Link
                                        key={i}
                                        href={item.link}
                                        className="group relative flex flex-col justify-between bg-white dark:bg-card border rounded-[48px] p-8 min-h-[240px] md:min-h-[260px] shadow-sm hover:shadow-lg transition-all duration-300 overflow-hidden cursor-pointer hover:scale-[1.02]"
                                    >
                                        {/* 상단 텍스트 */}
                                        <div className="pr-2">
                                    ...
                                    <CardContent className="relative p-8 h-full flex flex-col justify-center">
                                        <div className="space-y-6">
                                            <h3 className="text-2xl lg:text-3xl font-bold text-foreground leading-tight text-center">
                                                SaaS는 도입보다,{" "}
                                                <span className="text-primary">이후가 더 중요합니다</span>.
                                            </h3>
